...
const UserProfile = () => {
  ...
  const [fetchArticlesURL, setFetchArticlesURL] = useState(
    `${API_ENDPOINTS.ARTICLES}?author=${username}&limit=${ITEMS_PER_PAGE}&offset=0`
  );
  ...
  useEffect(() => {
    ...
    if (tab === "fav-articles") {
      setFetchArticlesURL(
        `${API_ENDPOINTS.ARTICLES}?favorited=${username}&limit=${ITEMS_PER_PAGE}&offset=0`
      );
    }
  }, [username, tab]);
            ...
            <div className="col-xs-12 col-md-10 offset-md-1">
              <div className="article-tabs">
                <ul className="nav nav-tabs">
                  <li
                    className="nav-item all-articles"
                  ...
                  <li
                    className="nav-item fav-articles"
                    onClick={() => handleTabClick("fav-articles")}
                  >
                    <button
                      id="all"
                      className={`nav-link ${
                        tab === "fav-articles" ? "active" : ""
                      }`}
                    >
                      Favorite Articles
                    </button>
